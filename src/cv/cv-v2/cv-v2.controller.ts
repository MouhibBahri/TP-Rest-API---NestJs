  ...
  async uploadImage(
    ...
    @UploadedFile(
      new ParseFilePipeBuilder()
        .addFileTypeValidator({ fileType: /image\/(jpeg|jpg|png)/ }) // Validate file type
        .addMaxSizeValidator({ maxSize: 1_000_000 }) // Validate file size (1 MB)
    ...
    return this.cvService.updateImage(+id, file.filename);
  }
